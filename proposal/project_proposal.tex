...
\begin{itemize}
  \item Month 1 (February 2025)
    \begin{itemize}
      ...
      \item Begin the process of contributing the course to the The Carpentries by creating a proposal GitHub issue with the The Carpentries Incubator~\citemain{carpentries_incubator_proposals}.
    \end{itemize}
